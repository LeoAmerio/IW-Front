    ...
    <div className="bg-secondary py-16 sm:py-24 relative overflow-hidden" id="testimonials">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-extrabold text-foreground sm:text-4xl">Clientes felices te cuentan su experiencia</h2>
          <p className="mt-4 text-xl text-muted-foreground">
            Mas de 1000 inquilinos ya se sumaron a Housinger, y esto es lo que dicen de nosotros.
          </p>
        </motion.div>
