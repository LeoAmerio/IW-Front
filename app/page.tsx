      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Bienvenido a Housinger.</strong> La mejor herramienta de administracion{' '}
            <a href="#" className="text-blue-500">
              para su edificio
            </a>
            , creado por nuestro equipo, con amor.
          </p>
          <Link
            href="/login"
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <Image src='/desk.png' alt='Screenshot of the dash' width={1000} height={760} className='hidden md:block' />
          <Image src='/mob.png' alt='Screenshot of the dash' width={560} height={620} className='block md:hidden' />
        </div>
      </div>
    </main>
  );
